CREATE VIEW coctails.v_recipeIngredientTypes AS (
	SELECT
		...
		,CASE
			...
			THEN 1
			ELSE 0 END AS includesChampagne
		,CASE
			WHEN 
		...
		,CASE
			...
			THEN 1
			ELSE 0 END AS includesAperative
